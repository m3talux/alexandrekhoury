...
export default function Nav() {
    return (
        <nav className="h-24 w-screen px-8 md:px-32 py-8 flex justify-between items-center">
            <a href="/">
                <Image src="/svg/logo.svg" className="w-[48px] h-auto sm:w-[56px]" alt="Alexandre El Khouy | Logo" width={56} height={56}/>
            </a>
            <div className="flex justify-center items-center">
                <a href="#contact" className="text-gray-600 mr-8 hover:cursor-pointer hover:text-gray-900">Contact</a>
